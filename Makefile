...
CODE= code/escrito-if.pl  code/escrito3.pl  code/escrito2.pl  code/escrito.pl  code/peta2.pl  code/peta1.pl  code/silabas-devil.pl code/hola.pl code/hola.py code/hola.rb code/hola-y-duerme.pl
